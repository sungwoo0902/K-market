...
@WebServlet("/admin/notice/seletDelete.do")
public class Admin_NoticeSelectDeleteController extends HttpServlet {

    private static final long serialVersionUID = 1232344352L;
    private Logger logger = LoggerFactory.getLogger(Admin_NoticeSelectDeleteController.class);
