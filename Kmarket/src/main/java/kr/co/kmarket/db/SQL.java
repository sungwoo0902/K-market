...
public class SQL {
	...
	public final static String SELECT_PRODUCTS_BY_CATE1 = "SELECT a.*, b.level, b.company FROM `km_product` AS a JOIN `km_member` AS b ON a.seller=b.uid WHERE `stock` > 0 AND `prodCate1`=? LIMIT ?, 10";
